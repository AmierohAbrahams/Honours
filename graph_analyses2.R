...
# Only working with sites that overlap in the year 2005
...
load("~/Honours/R assignment/Honours/SACTNdaily_v4.1.Rdata")
...
ggplot(final_time,aes(x = date, y = temp)) +
...
# Graph showwing the sites and seasons

ggplot(all1, aes(x = date, y = temp)) +
  geom_line(aes(colour = src)) +
