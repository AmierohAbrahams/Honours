...
load("~/Honours/R assignment/Honours.P/greymap/sa_provinces.RData")
site_coordinates_new <- read_csv("greymap/site_coordinates_new.csv")
load("~/Honours/R assignment/Honours.P/greymap/south_africa_coast.RData")
